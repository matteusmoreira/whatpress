-- Sistema de Roles Aprimorado - Baseado no Astra Campaign (Versão Corrigida)
...
DROP POLICY IF EXISTS "Read own actions log" ON public.user_actions_log;
...
DROP POLICY IF EXISTS "Insert own actions log" ON public.user_actions_log;
